        ...
        <div className="welcome-page relative isolate flex min-h-[100dvh] flex-1 flex-col bg-[#05070F] text-[#F4F6FB]">
            <section className="welcome-hero relative flex min-h-[100dvh] flex-1 flex-col overflow-hidden">
                ...
                <header className="welcome-fade welcome-fade-1 relative z-20 flex items-center justify-between gap-4 px-5 pt-6 md:px-10 md:pt-8">
                    ...
                    >
                        <button type="button" className="welcome-nav-link font-welcome-body" onClick={openDiscover}>
            ...
            {discoverOpen && (
                <section
                    id="welcome-discover"
                    className="discover-section px-5 py-14 md:px-10 md:py-16"
                >
                    <div className="mx-auto w-full max-w-6xl">
                        <h2 className="font-welcome-display text-4xl tracking-tight text-white md:text-5xl">
                            {t('discoverTitle')}
                        </h2>
                        <p className="mt-4 max-w-2xl font-welcome-body text-sm leading-relaxed text-white/65 md:text-base">
                            {t('discoverHint')}
                        </p>
